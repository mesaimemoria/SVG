	...
	<body>
		...
		<th>
			<div class="circlerectangle">
				...
				<svg width="320" height="200" style="position: absolute; z-index: 1;">
				<circle cx="100" cy="140" r="25" fill="#d90000"/>
				</svg>
				<svg width="320" height="300" style="position: absolute; z-index: 1;">
				<circle cx="100" cy="240" r="25" fill="#d90000"/>
				</svg>
				...
				<svg height="50" style="margin-top: 60px; position: absolute;">
				   <polyline points="0,20 20,40 40,40 40,60 60,80 80,80 80,100 100,100 100,120 120,120 120,140 140" fill="none" stroke-width="3" stroke="#000" transform="rotate(-45)"/>
				</svg>
				<svg width="320" height="90" style="position: absolute; margin-left: 85px; margin-top: 130px; z-index: 1;">
				<polygon points="0 0, 0 50, 50 0" fill="#fff" transform="rotate(45)"/>
				</svg>
				<svg width="320" height="80" style="margin: 10px;">
				   <rect width="180" height="80" fill="#fff"/>
